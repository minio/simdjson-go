...
//go:noescape
func _find_structural_bits(p1, p2, p3 unsafe.Pointer,                                     /* for: find_odd_backslash_sequences()    */
...
func find_structural_bits(buf []byte, prev_iter_ends_odd_backslash *uint64,
	...
	return _find_structural_bits(unsafe.Pointer(&buf[0]), unsafe.Pointer(&buf[32]), unsafe.Pointer(prev_iter_ends_odd_backslash),
